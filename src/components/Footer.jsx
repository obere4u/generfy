...
const Footer = () => {
  ...
  return (
    <footer className="w-full mt-auto bg-zinc-900 border-t-2 p-6 py-6">
      <div className="max-w-screen-2xl  mx-auto ">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            {/* Social Icon */}
            <div>
              <h2 className="mb-6 text-sm font-semibold text-neutral-100 uppercase dark:text-white">
                Follow us
              </h2>
              <ul className="text-neutral-400 dark:text-gray-400 font-medium">
                <li className="mb-4">
                  <a
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex sm:justify-center sm:mt-0">
            ...
            <a
              ...
              className="text-neutral-400 hover:text-neutral-200 dark:hover:text-white ms-5"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-4 h-4"
